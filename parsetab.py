...
_lr_signature = '4C554F978B972E1B82ED3D20A534C99E'
...
_lr_productions = [
  ...
  ('program -> globalVarDeclar functionDeclar main','program',3,'p_program','RiperPar.py',34),
  ('globalVarDeclar -> initVarDeclar','globalVarDeclar',1,'p_globalVarDeclar','RiperPar.py',38),
  ('initVarDeclar -> varDeclar initVarDeclar','initVarDeclar',2,'p_initVarDeclar','RiperPar.py',48),
  ('initVarDeclar -> <empty>','initVarDeclar',0,'p_initVarDeclar','RiperPar.py',49),
  ('functionDeclar -> function functionDeclar','functionDeclar',2,'p_functionDeclar','RiperPar.py',51),
  ('functionDeclar -> <empty>','functionDeclar',0,'p_functionDeclar','RiperPar.py',52),
  ('varDeclar -> vars ;','varDeclar',2,'p_varDeclar','RiperPar.py',55),
  ('varDeclar -> ARRAY arrays ;','varDeclar',3,'p_varDeclar','RiperPar.py',56),
  ('vars -> type ID = expression moreVar','vars',5,'p_vars','RiperPar.py',60),
  ('moreVar -> , ID = expression moreVar','moreVar',5,'p_moreVar','RiperPar.py',77),
  ('moreVar -> <empty>','moreVar',0,'p_moreVar','RiperPar.py',78),
  ('type -> INTTYPE','type',1,'p_type','RiperPar.py',91),
  ('type -> FLOATTYPE','type',1,'p_type','RiperPar.py',92),
  ('type -> STRINGTYPE','type',1,'p_type','RiperPar.py',93),
  ('type -> BOOLTYPE','type',1,'p_type','RiperPar.py',94),
  ('arrays -> array moreArray','arrays',2,'p_arrays','RiperPar.py',101),
  ('array -> type ID [ INT ] = { expression sumExpCount moreExp }','array',11,'p_array','RiperPar.py',104),
  ('moreExp -> , expression sumExpCount moreExp','moreExp',4,'p_moreExp','RiperPar.py',116),
  ('moreExp -> <empty>','moreExp',0,'p_moreExp','RiperPar.py',117),
  ('sumExpCount -> <empty>','sumExpCount',0,'p_sumExpCount','RiperPar.py',120),
  ('moreArray -> nextArray moreArray','moreArray',2,'p_moreArray','RiperPar.py',127),
  ('moreArray -> <empty>','moreArray',0,'p_moreArray','RiperPar.py',128),
  ('nextArray -> , ID [ INT ] = { expression sumExpCount moreExp }','nextArray',11,'p_nextArray','RiperPar.py',131),
  ('function -> FUNCTION funcType ID ( par ) { block RETURN returnType ; }','function',12,'p_function','RiperPar.py',142),
  ...
  ('higherExp -> exp possibleExp','higherExp',2,'p_higherExp','RiperPar.py',298),
  ('possibleExp -> possibleExpOp exp','possibleExp',2,'p_possibleExp','RiperPar.py',302),
  ('possibleExp -> <empty>','possibleExp',0,'p_possibleExp','RiperPar.py',303),
  ('possibleExpOp -> LESS','possibleExpOp',1,'p_possibleExpOp','RiperPar.py',307),
  ('possibleExpOp -> GREATER','possibleExpOp',1,'p_possibleExpOp','RiperPar.py',308),
  ('possibleExpOp -> LESSEQUAL','possibleExpOp',1,'p_possibleExpOp','RiperPar.py',309),
  ('possibleExpOp -> GREATEREQUAL','possibleExpOp',1,'p_possibleExpOp','RiperPar.py',310),
  ('possibleExpOp -> DIFFERENT','possibleExpOp',1,'p_possibleExpOp','RiperPar.py',311),
  ('possibleExpOp -> EQUALTO','possibleExpOp',1,'p_possibleExpOp','RiperPar.py',312),
  ('exp -> possibleSign term possibleTerms','exp',3,'p_exp','RiperPar.py',376),
  ('possibleTerms -> possibleTermOp possibleSign term possibleTerms','possibleTerms',4,'p_possibleTerms','RiperPar.py',380),
  ('possibleTerms -> <empty>','possibleTerms',0,'p_possibleTerms','RiperPar.py',381),
  ('possibleSign -> +','possibleSign',1,'p_possibleSign','RiperPar.py',384),
  ('possibleSign -> -','possibleSign',1,'p_possibleSign','RiperPar.py',385),
  ('possibleSign -> <empty>','possibleSign',0,'p_possibleSign','RiperPar.py',386),
  ('possibleTermOp -> +','possibleTermOp',1,'p_possibleTermOp','RiperPar.py',389),
  ('possibleTermOp -> -','possibleTermOp',1,'p_possibleTermOp','RiperPar.py',390),
  ('term -> factor possibleFactors','term',2,'p_term','RiperPar.py',396),
  ('possibleFactors -> possibleFactorOp factor possibleFactors','possibleFactors',3,'p_possibleFactors','RiperPar.py',400),
  ('possibleFactors -> <empty>','possibleFactors',0,'p_possibleFactors','RiperPar.py',401),
  ('possibleFactorOp -> *','possibleFactorOp',1,'p_possibleFactorOp','RiperPar.py',405),
  ('possibleFactorOp -> /','possibleFactorOp',1,'p_possibleFactorOp','RiperPar.py',406),
  ('possibleFactorOp -> %','possibleFactorOp',1,'p_possibleFactorOp','RiperPar.py',407),
  ('factor -> lPar expression rPar','factor',3,'p_factor','RiperPar.py',414),
  ('factor -> data','factor',1,'p_factor','RiperPar.py',415),
  ('lPar -> (','lPar',1,'p_lPar','RiperPar.py',418),
  ('rPar -> )','rPar',1,'p_rPar','RiperPar.py',423),
  ('data -> ID possibleIdCall','data',2,'p_data','RiperPar.py',430),
  ('data -> constant','data',1,'p_data','RiperPar.py',431),
  ('data -> input','data',1,'p_data','RiperPar.py',432),
  ('possibleIdCall -> [ expression ]','possibleIdCall',3,'p_possibleIdCall','RiperPar.py',444),
  ('possibleIdCall -> ( parIn )','possibleIdCall',3,'p_possibleIdCall','RiperPar.py',445),
  ('possibleIdCall -> <empty>','possibleIdCall',0,'p_possibleIdCall','RiperPar.py',446),
  ('constant -> INT','constant',1,'p_constant','RiperPar.py',450),
  ('constant -> FLOAT','constant',1,'p_constant','RiperPar.py',451),
  ('constant -> TRUE','constant',1,'p_constant','RiperPar.py',452),
  ('constant -> FALSE','constant',1,'p_constant','RiperPar.py',453),
  ('constant -> STRING','constant',1,'p_constant','RiperPar.py',454),
  ('input -> INPUT ( inputPar )','input',4,'p_input','RiperPar.py',460),
  ('inputPar -> STRING','inputPar',1,'p_inputPar','RiperPar.py',463),
  ('inputPar -> <empty>','inputPar',0,'p_inputPar','RiperPar.py',464),
]
